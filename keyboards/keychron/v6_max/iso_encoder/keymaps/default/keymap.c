...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_110(
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,    KC_MPLY,    KC_SNAP,  KC_F13,   RGB_MOD,  KC_F13,   KC_F14,   KC_F15,   KC_F16,
        ...
        KC_LCTL,  KC_LCMMD, KC_LOPTN,                               KC_SPC,                                 KC_ROPTN, KC_RCMMD, MO(MAC_FN), KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT,  KC_PENT),
